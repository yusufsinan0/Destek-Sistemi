...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Oluşurduğunuz Talepler</h5>
    ...
    <tr>
        ...
        <td><?php echo htmlspecialchars($request['Request_Firstname']); echo htmlspecialchars($request['Request_Lastname']); ?></td>
